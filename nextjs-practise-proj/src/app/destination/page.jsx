      ...
      <div className="flex flex-col gap-4">
        {destination.map((d, index) => {
          return (
            <div
              key={index}
              className="text-black font-bold text-2xl flex items-center justify-center rounded-2xl w-48 h-25 bg-white hover:scale-105 hover:bg-blue-200 cursor-pointer transition-all duration-300"
            >
              {d}
            </div>
          );
